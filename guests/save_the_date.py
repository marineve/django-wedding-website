...
def get_save_the_date_context(template_id):
    ...
    context['page_title'] = 'Marin and Riley - Save the Date!'
...
def send_save_the_date_email(context, recipients, test_only=False):
    ...
    template_text = "Save the date for Marin and Riley's wedding! July 2, 2016. Niagata-on-the-Lake, Ontario, Canada"
